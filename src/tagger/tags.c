...
void hash_to_tag(int hash, char tag[5]){
    switch(hash){
        ...
        case COL: strcpy(tag, "col"); break;
        case DQ: strcpy(tag, "dq"); break;
        case SCOL: strcpy(tag, "scol"); break;
        case LPAR: strcpy(tag, "lpar"); break;
        case RPAR: strcpy(tag, "rpar"); break;
        case PER: strcpy(tag, "per"); break;
        case COM: strcpy(tag, "com"); break;
        case QUE: strcpy(tag, "que"); break;
